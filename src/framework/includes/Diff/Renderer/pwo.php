...
/** Text_Diff_Renderer */
require_once str_replace('\\','/',dirname(__FILE__).'/').'../Renderer.php';
 ...
 * @package Text_Diff
 */
class Text_Diff_Renderer_pwo extends Text_Diff_Renderer {
     ...
     */
    var $_ins_prefix = '[class=diff_inserted]';

    /**
     * Suffix for inserted text.
     */
    var $_ins_suffix = '[/class]';

    /**
     * Prefix for deleted text.
     */
    var $_del_prefix = '[class=diff_deleted]';

    /**
     * Suffix for deleted text.
     */
    var $_del_suffix = '[/class]';
